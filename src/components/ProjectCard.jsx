function ProjectCard({ project }) {
  if (project.isPlaceholder) {
    return (
      <article className="flex min-h-[20rem] w-full max-w-[24.25rem] flex-col overflow-hidden rounded-lg border border-dashed border-[color:var(--outline-variant)]/30 bg-[color:rgba(42,42,42,0.4)] md:h-[20rem]">
  ...
  return (
    <article className="group flex min-h-[20rem] w-full max-w-[24.25rem] flex-col overflow-hidden rounded-lg border border-[color:var(--outline-variant)]/15 bg-[var(--surface-container-high)] shadow-[0_8px_24px_rgba(0,0,0,0.14)] transition-all duration-300 hover:-translate-y-1 hover:border-[color:var(--secondary)]/18 hover:shadow-[0_14px_30px_rgba(0,0,0,0.2)] md:h-[20rem]">
      ...
      <div className="flex flex-1 flex-col px-4 pt-3 pb-[3px]">
        ...
        <div className="project-tags-clamp mb-3 flex flex-wrap gap-1.5 overflow-hidden">
